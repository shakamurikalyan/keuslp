...
<nav class="${"navbar fixed-top pt-0 pb-0 navbar-expand-lg navbar-light bg-light svelte-1ch36o"}"><div class="${"container-fluid"}"><a class="${"navbar-brand"}" href="${"#"}"><img src="${"images/logo.png"}" alt="${"logo"}" class="${"mainLogo svelte-1ch36o"}"></a>
...
//# sourceMappingURL=_layout.svelte-25ab5be5.js.map
