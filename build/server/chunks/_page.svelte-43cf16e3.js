...
const MobSec8 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"mobContent8 svelte-1bt6vzf"}"><div class="${"mob8"}"><h1 class="${"mobHead8 svelte-1bt6vzf"}">Smart home at your command
        ...
        <div class="${"mobImg8 svelte-1bt6vzf"}"><img src="${"images/bedRoom.png"}" alt="${"bedroom image"}" class="${"mimg8 svelte-1bt6vzf"}">
            <img src="${"images/voice.png"}" alt="${"voice control image"}" class="${"mvimg8 svelte-1bt6vzf"}"></div>
        ${each(obj, (o, i) => {
    return `<h1 class="${"mobTitle8 svelte-1bt6vzf"}">${escape(o.title)}</h1>
            <p class="${"mobd8 svelte-1bt6vzf"}">${escape(o.desc)}</p>`;
  })}
        <div class="${"mobImg8-1"}"><img src="${"images/googleHome.png"}" alt="${"google home image"}" class="${"mimg8-1 svelte-1bt6vzf"}"></div>
        <div class="${"mobImg8-2"}"><img src="${"images/alexa.png"}" alt="${"alexa image"}" class="${"mimg8-2 svelte-1bt6vzf"}"></div>
          ...
          default: () => {
            return `<div class="${"mobSlide10"}"><div class="${"mobVdiv10 svelte-1r49ouj"}">${`<span class="${"playBtn10 svelte-1r49ouj"}" style="${"scale:" + escape(scale$1, true)}">${validate_component(Fa, "Fa").$$render(
              ...
              {}
                                ...
                                <video${add_attribute("src", o?.link, 0)} preload="${"auto"}" poster="${"videos/" + escape(tabs[i], true) + "/poster.jpg"}" class="${"mobV10 svelte-1r49ouj"}"></video></div>
          ...
          default: () => {
            return `<h1 class="${"mobTitle11 svelte-fm9sis"}">${escape(o.title)}</h1>
              ...
              {}
                            ...
                            <video${add_attribute("src", o?.link, 0)} preload="${"auto"}" poster="${"videos/homes/" + escape(i + 1, true) + "/poster.jpg"}" class="${"mobV11 svelte-fm9sis"}"></video></div>
                    `;
          }
        })}`;
      })}`;
...
const css = {
  code: ".desc.svelte-3qeqte{width:24.51833vw;font-size:1.30vw}.section.svelte-3qeqte{min-height:100vh;min-width:100%;position:relative;overflow:hidden}.section1.svelte-3qeqte{background-size:100% 100%;color:transparent;background-repeat:no-repeat;overflow:hidden;min-height:100vh}.mainHeading.svelte-3qeqte{font-family:'Playfair Display', serif;font-weight:700;font-size:3.13vw}.cardText.svelte-3qeqte,.cardHeading.svelte-3qeqte{color:#282828;margin:auto}.cardHeading.svelte-3qeqte{font-family:'Playfair Display', serif;font-weight:400;font-size:2.09vw}.cardText.svelte-3qeqte{font-family:'Raleway', sans-serif;font-size:0.73vw;line-height:1.044vw}.content.svelte-3qeqte{margin:40vh 0 0;width:85%}.intro.svelte-3qeqte{margin:30vh 15vw 0}.section2.svelte-3qeqte{position:absolute;padding:2.0866vw 0 0;top:10vh;left:58%;min-width:27vw}.input.svelte-3qeqte{width:20.86vw;margin:1.044vw auto}.form.svelte-3qeqte{width:26.0834vw;position:inherit}.formContent.svelte-3qeqte{padding:1.82583vw}.submit.svelte-3qeqte{width:20.86vw;height:2.869vw;color:#fff;background-color:#835031;margin:1vw 0 0;font-size:1.044vw;border:none}.section3.svelte-3qeqte,.section4.svelte-3qeqte{background-color:#E3DDD9}.section5.svelte-3qeqte{background-color:#C8B8AD;overflow:hidden}.section7.svelte-3qeqte{background-color:#E3DDD9;overflow:hidden}.section8.svelte-3qeqte{min-height:100vh}.section9.svelte-3qeqte{background-color:#E3DDD9}.section10.svelte-3qeqte{min-height:10vh}.section11.svelte-3qeqte{overflow:hidden}.section12.svelte-3qeqte{min-height:80vh;background-color:#E3DDD9}.section13.svelte-3qeqte{background-color:#202020;min-height:80vh}@media screen and (max-width:900px){.svelte-3qeqte::-webkit-scrollbar{display:none}.svelte-3qeqte{-ms-overflow-style:none;scrollbar-width:none}.mainHeading.svelte-3qeqte{font-size:48px}.content.svelte-3qeqte{margin:40vh auto;width:100%}.intro.svelte-3qeqte{width:80%;margin:auto;text-align:left}.section1.svelte-3qeqte{min-height:110vh;background-size:cover}.desc.svelte-3qeqte{width:320px;font-size:20px}.cardHeading.svelte-3qeqte{font-size:45px;line-height:50px}.cardText.svelte-3qeqte{font-size:18px;line-height:25px;width:288px}.section2.svelte-3qeqte{position:relative;padding:0;min-height:10vh;min-width:100%;background:#fff;left:0;top:0}.form.svelte-3qeqte{width:370px;position:inherit;margin:50px auto}.input.svelte-3qeqte,.submit.svelte-3qeqte{width:288px}.submit.svelte-3qeqte{margin:20px auto;height:auto}}",
  map: null
};
...
<div class="${"main svelte-3qeqte"}">
        <div class="${"section1 section svelte-3qeqte"}" style="${"background-image: url(images/hall.jpg);"}"><div class="${"content svelte-3qeqte"}"><div class="${"intro svelte-3qeqte"}"><h1 class="${"mainHeading ani1 svelte-3qeqte"}">Truly smart</h1>
                    <h1 class="${"mainHeading ani2 svelte-3qeqte"}">Truly wireless</h1><br class="${"svelte-3qeqte"}">
                    <p class="${"desc ani3 svelte-3qeqte"}">The Keus smart home is a wireless marvel that delivers deep automation experiences that are easy to install, easier to configure and easiest to use.</p></div></div></div>
    
    <div class="${"section2 section svelte-3qeqte"}"><div class="${"form " + escape("mx-auto", true) + " svelte-3qeqte"}">${validate_component(Card, "Card").$$render(
    $$result,
    {
    ...
    {},
    {
      default: () => {
        return `${validate_component(CardBody, "CardBody").$$render($$result, {}, {}, {
          default: () => {
            return `<form class="${"formContent svelte-3qeqte"}"><h3 class="${"cardHeading mb-3 svelte-3qeqte"}">Smart home demo</h3>
                        <p class="${"cardText mb-3 svelte-3qeqte"}">KEUS smart home helps unlock the potential of your spaces to create memorable and transformative experiences.</p>
                        <div class="${"inputs svelte-3qeqte"}"><div class="${"input svelte-3qeqte"}">${validate_component(Input, "Input").$$render(
              $$result,
              {
                type: "text",
              ...
              {}
                            ...
                            <div class="${"input svelte-3qeqte"}">${validate_component(Input, "Input").$$render(
              $$result,
              {
                type: "text",
                placeholder: "*Mobile",
              ...
              {}
                            ...
                            <div class="${"input svelte-3qeqte"}">${`${validate_component(Select, "Select").$$render($$result, { placeholder: "*Property type" }, {}, {})}`}</div>
                            <div class="${"input svelte-3qeqte"}">${`${validate_component(Select, "Select").$$render($$result, { placeholder: "Property size" }, {}, {})}`}</div>
                            <div class="${"input svelte-3qeqte"}">${`${validate_component(Select, "Select").$$render($$result, { placeholder: "State of construction" }, {}, {})}`}</div></div>
                        ${`<button class="${"submit svelte-3qeqte"}" type="${"submit"}" style="${"font-size:20px;padding:15px;"}">Book your appointment</button>`}</form>`;
          }
        })}`;
      }
    }
  )}</div></div>
    <div class="${"section3 section svelte-3qeqte"}">${`${validate_component(MobSection3, "Mob3").$$render($$result, {}, {}, {})}`}</div>
    <div class="${"section4 section svelte-3qeqte"}">${`${validate_component(MobSec4, "Mob4").$$render($$result, {}, {}, {})}`}</div>
    <div class="${"section section5 svelte-3qeqte"}">${`${validate_component(MobSec5, "Mob5").$$render($$result, {}, {}, {})}`}</div>
    <div class="${"section section6 svelte-3qeqte"}">${`${validate_component(MobSec6, "Mob6").$$render($$result, {}, {}, {})}`}</div>
    <div class="${"section section7 svelte-3qeqte"}">${`${validate_component(MobSec7, "Mob7").$$render($$result, {}, {}, {})}`}</div>
    <div class="${"section section8 svelte-3qeqte"}">${`${validate_component(MobSec8, "Mob8").$$render($$result, {}, {}, {})}`}</div>
    <div class="${"section9 section svelte-3qeqte"}">${`${validate_component(MobSec9, "Mob9").$$render($$result, {}, {}, {})}`}</div>
    <div class="${"section section10 svelte-3qeqte"}">${`${validate_component(MobSec10, "Mob10").$$render($$result, {}, {}, {})}`}</div>
    <div class="${"section section11 svelte-3qeqte"}">${`${validate_component(MobSec11, "Mob11").$$render($$result, {}, {}, {})}`}</div>
    <div class="${"section12 section svelte-3qeqte"}">${`${validate_component(MobSec12, "Mob12").$$render($$result, {}, {}, {})}`}</div>
    <div class="${"section13 section svelte-3qeqte"}">${`${validate_component(MobSec13, "Mob13").$$render($$result, {}, {}, {})}`}</div>
</div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-43cf16e3.js.map
